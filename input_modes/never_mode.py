...
agent_guess_animal =  ConversableAgent(
    ...
    system_message="I have an animal in my mind, and you will try to guess it. If I give you a hint, use it to narrow down your guesses.",
    llm_config = llm_config,
    human_input_mode="NEVER")

response = agent_with_animal.initiate_chat(
    agent_guess_animal, 
